...
import { ARBITRARY_COMPONENT_FOLDER_PATH, FIREJET_SAVE_DATA_PATH,
    } from "./SHIM_CONSTANTS";

const saveFile = { pages: 
    {
        main: { componentData: [
            {
                type: "EXISTING_COMPONENT", x: 100,
                y: 400,
                width: 300,
                height: 400,
                filePath: "/App.jsx", exportName: "default",
            }, {
                type: "EXISTING_COMPONENT", x: 700,
                y: 0,
                width: 500,
                height: 100,
...
export const DEFAULT_REACT_LOADING_FILES: SandpackBundlerFiles = { 
    "/App.tsx": {
        ...
        return <div style={{width: "100%", height:"90vh", overflow:'none', display:"grid", placeItems:"center"}}><svg xmlns="http://www.w3.org/2000/svg"
        width="72px"
        height="72px"
        viewBox="0 0 100 100"
...
export const DEFAULT_REACT_FILES: SandpackBundlerFiles = {
    ...
    [`${ARBITRARY_COMPONENT_FOLDER_PATH}/1/HelloWorld.js`]: {
        code: /*tsx*/`export default function HelloWorld() {return <p> Test Test 123
            <br />
            Test 2 1245
            <br /> <b>
            <u>Wowzer</u></b> <div>Testing</div> <div>
            <b style={{ textDecorationLine: "underline"}}>Hee </b> <i>ha ha</i>
            </div>
            </p>}`, 
    },
    "/tailwind.config.js": {
        code: `/** @type {import('tailwindcss').Config} */ module.exports = {
            content: ["./**/*.{js,jsx,ts,tsx}"], theme: {
            extend: {}, },
            plugins: [], };`, 
    },
    ...
    "/styles.css": {
        code: `
            @import url('https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&family=Montserrat:ital,wght@0,
            @tailwind base; @tailwind components; @tailwind utilities;
            body {
            font-family: sans-serif; -webkit-font-smoothing: auto; -moz-font-smoothing: auto; -moz-osx-font-smoothing: grayscale; font-smoothing: auto;
            text-rendering: optimizeLegibility; font-smooth: always; -webkit-tap-highlight-color: transparent; -webkit-touch-callout: none;
            }
            h1 {
            font-size: 1.5rem;
            }`, 
